...
<template>
  ...
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col m-1 rounded-lg">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div class="flex min-h-0 flex-1 flex-col bg-gray-800 rounded-lg">
        <div class="flex h-16 flex-shrink-0 items-center bg-gray-900 px-4 rounded-lg">
          <img
            class="h-8 w-auto"
            src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500"
            alt="Your Company"
    ...
    <div class="flex flex-col lg:pl-64">
      <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white border-gray-200 border-2 rounded-lg m-3">
        <button
          type="button"
        ...
        <div class="py-6">
          ...
          <div class="flex">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <nav class="flex space-x-4 bg-white border-gray-200 border-2 rounded-lg py-3 px-5" aria-label="Tabs">
                <a
                  v-for="tab in tabs"
                  :key="tab.name"
                  :href="tab.href"
         ...
         <div class="min-h-screen border-gray-200 border-2 rounded-lg m-3 px-3 py-5 mt-10">
