    ...
    <div class="mx-auto max-w-7xl px-6 py-24 sm:pt-32 lg:py-40 lg:px-8">
      <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        <div class="lg:col-span-5">
          ...
          <p class="mt-4 text-base leading-7 text-gray-600">Can’t find the answer you’re looking for? Reach out to our <NuxtLink href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">customer support</NuxtLink> team.</p>
        </div>
